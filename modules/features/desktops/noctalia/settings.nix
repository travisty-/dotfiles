  ...
  flake.modules.homeManager.noctalia = {
    programs.noctalia-shell.settings = {
      ...
      bar = {
        ...
        widgets = {
          center = [{id = "Workspace";}];
          left = [{id = "Launcher";} {id = "Clock";} {id = "SystemMonitor";} {id = "ActiveWindow";} {id = "MediaMini";}];
          right = [{id = "Tray";} {id = "NotificationHistory";} {id = "Battery";} {id = "Volume";} {id = "Brightness";} {id = "ControlCenter";}];
        };
      };
      brightness = {
